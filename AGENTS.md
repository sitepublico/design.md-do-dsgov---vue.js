...
> Este arquivo é o **ponto de entrada** para qualquer agente (Claude Code, Cursor, Copilot, etc.).
> Leia-o antes de gerar ou editar qualquer código. Para Claude Code, mantenha uma cópia como `CLAUDE.md`
> (ou um symlink: `ln -s AGENTS.md CLAUDE.md`).
...
3. **`QUICKSTART_DSGOV_VUE.md` — setup do ambiente.** Só ao criar um projeto do zero. Em app existente,
   ignore-o e siga o `DESIGN.md` Seção 1.0.
...
## Stack de referência (projeto novo)
